...
LIBS=$(COCCI)/commons/commons.cma $(COCCI)/globals/globals.cma $(COCCI)/parsing_c/parsing_c.cma $(COCCI)/parsing_c/pretty_print_c.cmo db.cmo gtree.cmo difftype.cmo visitor_j.cmo diff.cmo main.cmo
