...
silent only
cd ~/CS/cocci/spfind/diff/tests/usb
...
badd +0 new-usb2.c
badd +0 new-usb.c
args usb1.c usb2.c usb.c new-usb1.c new-usb2.c new-usb.c
edit usb.c
...
exe '4resize ' . ((&lines * 9 + 15) / 30)
exe 'vert 4resize ' . ((&columns * 39 + 40) / 80)
exe '5resize ' . ((&lines * 9 + 15) / 30)
exe 'vert 5resize ' . ((&columns * 39 + 40) / 80)
exe '6resize ' . ((&lines * 8 + 15) / 30)
