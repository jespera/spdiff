...
silent only
cd /var/storage/cocci/spdiff/tests/ase-ex1
...
exe 'vert 1resize ' . ((&columns * 65 + 64) / 129)
exe '2resize ' . ((&lines * 19 + 21) / 42)
exe 'vert 2resize ' . ((&columns * 63 + 64) / 129)
exe '3resize ' . ((&lines * 19 + 21) / 42)
exe 'vert 3resize ' . ((&columns * 65 + 64) / 129)
exe '4resize ' . ((&lines * 19 + 21) / 42)
exe 'vert 4resize ' . ((&columns * 63 + 64) / 129)
argglobal
setlocal keymap=
setlocal noarabic
