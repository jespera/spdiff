...
nmap E :vnew | vimshell bash
nmap e :new | vimshell bash
nnoremap  :call PreviewTag(0)
inoremap Ý :call PreviewTag(1)
map Q gq
vmap [% [%m'gv``
...
imap  :w<Right>i
inoremap  :call PreviewTag(0)
noremap Û :pc
noremap Û :pc
nnoremap Ý :call PreviewTag(1)
cmap W w
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
...
silent only
cd ~/CS/cocci/spfind/diff/tests/paths-ex
...
exe '5resize ' . ((&lines * 11 + 18) / 37)
exe 'vert 5resize ' . ((&columns * 40 + 40) / 80)
exe '6resize ' . ((&lines * 11 + 18) / 37)
exe 'vert 6resize ' . ((&columns * 39 + 40) / 80)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
